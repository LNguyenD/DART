...
<body style="margin: 0;">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function adjustLayout() {
            ...
            //if (document.URL.toLowerCase().indexOf('tmf') > 0
            //    || document.URL.toLowerCase().indexOf('agency') > 0) {
            //    fixTotalColumnWidth(portfolioTable, 70);
            //}
            //else {
        ...
        function loadMonthReport() {
            ...
            if (weekReport.length > 0 && monthReportIframe.length < 1) {
                ...
                url += '?' + queryString + startDateParam + endDateParam;
        ...
        function fixPortfolioLayout() {
            ...
            //RemoveUnnecessaryMetricLight();
        }

        //function RemoveUnnecessaryMetricLight() {

        //    $("img[alt*='[CPR_']").each(function () {
                ...
                for (var i = 2; i < numberOfColumns; i++) {
                    ...
                    if (i < numberOfColumns - 1) {
                        ...
                        if (document.documentMode != 7 && document.documentMode != 8) {
                            ...
                            // TODO: temporary fix
                            //if (document.referrer.toLowerCase().indexOf('tmf') > -1
                            //    && document.referrer.toLowerCase().indexOf('agency') > -1
                            //    && document.referrer.toLowerCase().indexOf('health') > -1
                            //    && isLevel('level3')) {
                            //    cell.height(130);
                            //}
                            //else {
        ...
        function hideActionButtons() {
            ...
            $("img[alt*='print_graph_view']").hide();
            $("img[alt*='description_graph_view']").hide();
        ...
        function openCPRDetail(param) {
            ...
            if (isLevel('level2')) {
                ...
                // view detail
                $report = $('iframe[id*=ifTableReport_detail_' + currentType + ']', window.parent.document);
                if ($report.length > 0) {
