...
namespace EM_Report.Helpers
{
    public class Login
    {
        ...
        public static void LoginAction(ActionServiceReference.LoginResponse response, bool isrememberme, string domain)
        {
            Base.LoginSession = new LoginSession(response, isrememberme, domain, Base.LoginType);           
        }
        ...
        public static LoginResponse Authenticate(LogIn model, string domain)
        {
