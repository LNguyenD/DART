...
namespace EM_Report.Tests.Services
{
    ...
    public class AccountServiceTests : BaseServiceTests
    {
        ...
        public void TestExternalLogin_Success()
        {
            ...
            var result = accountService.Login(email, password, limitLoginAttemptsNumber, daysBlockedAttemptsNumber, systemId, LoginType.External);
        ...
        public void TestInternalLogin_Success()
        {
            ...
            // Act
            var accountService = new AccountService(repoMock.Object, _loginSession);
            var result = accountService.Login(username, null, limitLoginAttemptsNumber, daysBlockedAttemptsNumber, systemId, LoginType.Internal);
        ...
        public void InternalAutoLogin_Success()
        {
            ...
            var result = accountService.AutoLogin(1, "test", null, limitLoginAttemptsNumber, daysBlockedAttemptsNumber, systemId, LoginType.Internal);
        ...
        public void ExternalAutoLogin_Success()
        {
            ...
            // Act
            var accountService = new AccountService(userRepoMock.Object, _loginSession);
            var result = accountService.AutoLogin(1, email, password, limitLoginAttemptsNumber, daysBlockedAttemptsNumber, systemId, LoginType.External);
        ...
        public void TestResetPassWordSuccess()
        {
            ...
            var accountService = new AccountService(repoMock.Object,_loginSession);
            int result = accountService.ResetPassword(userOrEmail, newPassWord);
