...
BEGIN
	...
	IF UPPER(@System) = 'TMF'
	BEGIN
		INSERT INTO [Dart].[dbo].[TMF_Portfolio] EXEC [dbo].[usp_Dashboard_Portfolio] @System, @AsAt
	END
	ELSE IF UPPER(@System) = 'EML'
	BEGIN
		INSERT INTO [Dart].[dbo].[EML_Portfolio] EXEC [dbo].[usp_Dashboard_Portfolio] @System, @AsAt
	END
	ELSE IF UPPER(@System) = 'HEM'
	BEGIN
		INSERT INTO [Dart].[dbo].[HEM_Portfolio] EXEC [dbo].[usp_Dashboard_Portfolio] @System, @AsAt
	END
END
GO
SET QUOTED_IDENTIFIER OFF
