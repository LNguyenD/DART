...
namespace DesktopApp
{
    public partial class MainForm : Form
    {
        ...
        private void Deploy(string serverName, string dataSource, string database, string reportsFolder)
        {
            ...
            //string varServerPath = "http://10.9.0.26/ReportServer/ReportService2010.asmx";
            ...
            {
                MessageBox.Show("No report file was found");
                return;
            }
            ...
            try
            {
                ...
                SSRSDeployHelper helper = new SSRSDeployHelper(serverPath, username, password, connectionString, parentFolderPath, reportFolderName, datasetFolderName, datasourceFolderName, "", reportFilePath);
