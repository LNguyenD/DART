    ...
    public class ReportController : BaseController
    {
        ...
        public ActionResult ViewInfo(PortfolioReportParameters paramData, string reportpath)
        {
            var havePermission = ReportPermissionRepository.HaveReportPermission(Base.LoginSession.isSystemUser,
                reportpath.ToLower().Replace(Base.LoginSession.objConfig.ReportPathPrefix.ToLower(), ""),
        ...
        public ActionResult GetFileCabinetReports(string system, string dashboard, string level, string type, string value, string subValue)
        {
            ...
            if (normalReportCategory != null)
            {
                ...
                UpdateNormalReportsUrl(normalReports, system, dashboard, level, type, value, subValue);
            }
        ...
        private void UpdateNormalReportsUrl(List<Report> reports, string system, string dashboard, string level, string type, string value, string subValue)
        {
