...
if ($(".tab").length) {
    ...
    $('ul [id^="tab_"]').each(function (index) {
        $(this).click(function () {
            ...
            var lookaheadLevel3Crumbtrails = $("#lookaheadLevel3Crumbtrails").html();
            var lookaheadLevel4Crumbtrails = $("#lookaheadLevel4Crumbtrails").html();
            var lookaheadLevel5Crumbtrails = $("#lookaheadLevel5Crumbtrails").html();
            ...
            if (id_name == "tab_agencies") {
                ...
                $("#ifReportCover_Agency").css("display", "inline");
                ...
                if (level2CrumbtrailsRTW != null) {
                    if (systemName == "TMF") {
                        ...
                        $("#lookaheadLevel3Crumbtrails").html($("#lookaheadLevel3Crumbtrails").html().replace("group", "agency"));

                        //show level 4 5 lookahead crumtrails for agency
                        $("#lookaheadLevel4Crumbtrails").show();
                        $("#lookaheadLevel5Crumbtrails").show();

                        if (lookaheadLevel4Crumbtrails.indexOf('team') >= 0) {
                            $("#lookaheadLevel4Crumbtrails").html(lookaheadLevel4Crumbtrails.replace("team", "subcategory"));
                        }

                        if (lookaheadLevel5Crumbtrails.indexOf('team') >= 0) {
                            $("#lookaheadLevel5Crumbtrails").html(lookaheadLevel5Crumbtrails.replace("team", "subcategory"));
                        }
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('group') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('group', "employer size"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('account manager') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('account manager', "employer size"));
                        }
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('group') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('group', "portfolio"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('account manager') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('account manager', "portfolio"));
                        }
                        ...
                        if (lookaheadLevel4Crumbtrails.indexOf('team') >= 0) {
                            $("#lookaheadLevel4Crumbtrails").html(lookaheadLevel4Crumbtrails.replace("team", "employer size"));
                        }

                        if (lookaheadLevel5Crumbtrails.indexOf('team') >= 0) {
                            $("#lookaheadLevel5Crumbtrails").html(lookaheadLevel5Crumbtrails.replace("team", "employer size"));
                        }
                    }
                }
                ...
                $("#ifReportCover_Group").css("display", "inline");
                ...
                if (level2CrumbtrailsRTW != null) {
                    if (systemName == "TMF") {
                        ...
                        $("#lookaheadLevel3Crumbtrails").html($("#lookaheadLevel3Crumbtrails").html().replace("agency", "group"));
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('employer size') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('employer size', "group"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('account manager') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('account manager', "group"));
                        }
                        ...
                        if (lookaheadLevel4Crumbtrails.indexOf('subcategory') >= 0) {
                            $("#lookaheadLevel4Crumbtrails").html($("#lookaheadLevel4Crumbtrails").html().replace("subcategory", "team"));
                        }
                        else if (lookaheadLevel4Crumbtrails.indexOf('employer size') >= 0) {
                            $("#lookaheadLevel4Crumbtrails").html($("#lookaheadLevel4Crumbtrails").html().replace("employer size", "team"));
                        }

                        if (lookaheadLevel5Crumbtrails.indexOf('subcategory') >= 0) {
                            $("#lookaheadLevel5Crumbtrails").html($("#lookaheadLevel5Crumbtrails").html().replace("subcategory", "team"));
                        }
                        else if (lookaheadLevel5Crumbtrails.indexOf('employer size') >= 0) {
                            $("#lookaheadLevel5Crumbtrails").html($("#lookaheadLevel5Crumbtrails").html().replace("employer size", "team"));
                        }
                    }
                    else if (systemName == "Hospitality") {
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('portfolio') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('portfolio', "group"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('account manager') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('account manager', "group"));
                        }
                ...
                $("#ifReportCover_AccountManager").css("display", "inline");
                $("#ifReport_AccountManager").css("visibility", "visible");
                ...
                if (level2CrumbtrailsRTW != null) {
                    if (systemName == "WCNSW") {
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('employer size') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('employer size', "account manager"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('group') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('group', "account manager"));
                        }
                    ...
                    if (systemName == "Hospitality") {
                        ...
                        if (lookaheadLevel3Crumbtrails.indexOf('portfolio') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('portfolio', "account manager"));
                        }
                        else if (lookaheadLevel3Crumbtrails.indexOf('group') >= 0) {
                            $("#lookaheadLevel3Crumbtrails").html(lookaheadLevel3Crumbtrails.replace('group', "account manager"));
                        }
...
function ViewLargeGraph(url) {
    var reporturl = window.g_baseUrl + url;
    ViewReportByUrl(reporturl + "#viewlarge");
}

function ViewReportByUrl(Url) {
    if (document.URL.toLowerCase().indexOf("_level2") >= 0) {
        if ($("#tab_agencies").hasClass("tab_current")) {
            $('#ifReport_Agency').attr("src", Url);
        }
        else if ($("#tab_group").hasClass("tab_current")) {
            $('#ifReport_Group').attr("src", Url);
        }
        else if ($("#tab_account_manager").hasClass("tab_current")) {
            $('#ifReport_AccountManager').attr("src", Url);
        }
    }
    else {
...
//change tab level 1
//if ($(".tab").length) {
//    $('ul [id^="level1_tab_"]').each(function (index) {
//        $(this).click(function () {
//            $(".tab li").removeClass("tab_current");
//            $(this).addClass("tab_current");

//            var id_name = $(this).attr('id');
//            var tableAgencies = $("#ifReport").contents().find("table[alt='level1_agencies']");
//            var tableGroups = $("#ifReport").contents().find("table[alt='level1_groups']");

//            if (id_name == "level1_tab_agencies") {
//                //show agencies table
//                tableAgencies.show();
//                tableAgencies.parent('td').show();

//                //hide groups table
//                tableGroups.hide();
//                tableGroups.parent('td').prev('td').prev('td').height(0);

//                //adjust iframe height
//                changeIframeHeightLevel1(tableAgencies, $("#ifReport"));
//            }
//            else if (id_name == "level1_tab_group") {
//                //show groups table
//                tableGroups.show();

//                //hide agencies table
//                tableAgencies.hide();
//                tableAgencies.parent('td').prev('td').prev('td').height(0);
//                tableAgencies.parent('td').hide();

//                //adjust iframe height
//                changeIframeHeightLevel1(tableGroups, $("#ifReport"));
//            }
//        });
//    });
//}

//function changeIframeHeightLevel1(tab, iframe) {
//    var tabPosition = tab.position().top;
//    var tabBottom = tabPosition + tab.height();

//    iframe.height(tabBottom + 30);
//}
/***************************************************************
EQUAL HEIGHT
****************************************************************/
...
function openRawDataPopup(queryString) {
    var selfPopup = $(".viewRawDataContent");
    if (selfPopup.css("display") == "none") {
        var url = window.g_baseUrl + "/dashboard/RawData?" + queryString + "&rdr=" + Math.random();
        $.ajax({
            type: 'GET',
            url: url,
            async: false,
...
//open Portfolio Raw Data pop up
function openPortfolioRawDataPopup(queryString) {
    var selfPopup = $(".viewRawDataContent");
    if (selfPopup.css("display") == "none") {
        var url = window.g_baseUrl + "/Report/ReportRawData?" + queryString + "&rdr=" + Math.random();
        $.ajax({
            type: 'GET',
            url: url,
            async: false,
