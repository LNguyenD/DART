...
<head id="Head011" runat="server">
    ...
    <script src="../Scripts/jquery.columnmanager.min.js" type="text/javascript"></script>
    <script src="../Scripts/iPortfolio.js" type="text/javascript"></script>
    <style type="text/css">
        .hoverCell div
        {
...
<body style="margin: 0;">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function openPortfolioRawDataPopup(strHref) {
            if (strHref != null) {
                parent.openPortfolioRawDataPopup(strHref);
            }
        }
        ...
        function AdjustReport() {
            ...
            portfolioTable.find('a').mouseover(function () {
            ...
            portfolioTable.find('a').click(function (event) {
                var linkContent = $(this).html();
                if (linkContent == "-") {
        ...
        function RemoveTitle() {
            ...
            $("div[title^='DetailedPortfolio_']").removeAttr("title");
            $("td[title='[image_header_tablix]']").removeAttr("title");
            $("td[alt='[image_header_tablix]']").removeAttr("alt");
            $('table[alt*="portfolio"]').removeAttr('title');
            $('table[alt*="portfolio"] td[alt*="therapy"]').removeAttr('title');
            $('table[alt*="portfolio"] td[alt*="lump"]').removeAttr('title');
            $("div[title*='therapy_treat']").removeAttr("title");
            $("div[title*='lump_sum_int']").removeAttr("title");
        }
    </script>
</body>
</html>