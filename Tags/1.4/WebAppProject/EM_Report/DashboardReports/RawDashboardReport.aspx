        ...
        function viewerPropertyChanged(sender, e) {
            if (e.get_propertyName() == "isLoading") {
                ...
                if (document.URL.indexOf("=raw-") >= 0 || document.URL.indexOf("Graph=Raw") >= 0) {
                    $('iframe:eq(1)', window.parent.document).height(ifHeight + 'px');
                }
                else if (document.URL.indexOf("=Metric") >= 0) {
                    $('iframe:eq(2)', window.parent.document).height(ifHeight + 'px');
                }
                else {
                    $('iframe:eq(0)', window.parent.document).height(ifHeight + 'px');
                }
