...
function UnderlineSubTotalAndTotal() {
    ...
    if (document.URL.toLowerCase().indexOf("_level1") >= 1) {
        ...
        $("table[alt*='portfolio_week_agency']").find("> tbody > tr > td > div:contains('Clubs (Hospitality)')").css("text-decoration", "underline");
        $("table[alt*='portfolio_week_agency']").find("> tbody > tr > td > div:contains('Hotel')").css("text-decoration", "underline");
        $("table[alt*='portfolio_week_agency']").find("> tbody > tr > td > div:contains('Other')").css("text-decoration", "underline");
        // TMF        
    ...
    content.find("input").each(function () {
        ...
        if (flag == true) {
            ...
            if (href == "1-2" || href == "3-5") {
                ...
                href = href.replace("CPR", "Claims portfolio report");
                h1.html(href);
            }
        }
        flag = false;
            ...
            $("#overlay", window.parent.document).fadeIn('fast', function () {
                ...
                html2canvas(imgOnly, {
                    onrendered: function (canvas) {
                        ...
                        //printContentIframe.contents().find('body div#content').prepend("<img style='width: auto;height: auto' src=" + imgURL + "></img>");
                ...
                var printContentIframe = $("#printContent", window.parent.document);
                printContentIframe.contents().find('body').empty();
                //printContentIframe.contents().find('body').append('<span align="center" style="line-height: 1; position: absolute; top: 8px; right : 80px; font-family: arial; font-size: 11px; color: #ff0000">To copy or save <br /> please right click on the graph</span>');
                printContentIframe.contents().find('body').append('<div id="content" align="center" style="position: relative"><div id="graphTitle"</div></div>');
                printContentIframe.contents().find('body div#graphTitle').html(graphTitle);
                printContentIframe.contents().find('body div#graphTitle').css({ 'font-family': 'arial', 'font-size': '12pt', 'color': '#037baf', 'font-weight': '700' });
