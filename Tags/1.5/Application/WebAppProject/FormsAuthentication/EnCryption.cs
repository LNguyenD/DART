                ...
                foreach (XmlNode child in doc.DocumentElement.ChildNodes)
                {
                    if (child.Name == "connectionStrings")
                    {
                        foreach (XmlNode subChild in child.ChildNodes)
                        {
                            ...
                            {
                                if (!EnCryption.IsEncrypt(subChild.Attributes["connectionString"].Value))
                                {
                                    subChild.Attributes["connectionString"].Value = EnCryption.Encrypt(subChild.Attributes["connectionString"].Value);
                                    hasChange = true;
                                }
                            }
