...
function reloadReport() {
    ...
    var reportUrl = g_baseUrl + "/EMReports/Report.aspx?reportpath=/emreporting/reports/port";
...
function PortfolioTabChanged(me, newTabIndex) {
    ...
    var currentTabIndex = $(".tab .tab_current").index();
...
function setupConstraintsForCalendar() {
    ...
    End Date, Start Date min = 1st of last year
    ...
    */
    ...
    var firstDate = new Date(currentYear - 1, 0, 1);
...
function showDetailedRows(cell, type, numberOfRows) {
    ...
    var expandHeight = cell.height() * numberOfRows;
...
function hideDetailedRows(cell, type, numberOfRows) {
    ...
    var collapseHeight = cell.height() * numberOfRows * -1;
