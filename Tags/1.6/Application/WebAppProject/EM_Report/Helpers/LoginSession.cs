...
namespace EM_Report.Helpers
{
    ...
    public class LoginSession : RepositoryBase, I_LoginSessionExtend
    {
        ...
        public LoginSession(LoginResponse response, bool isrememberme, string domain, LoginType loginType)
        {
            ...
            if (user != null)
            {
                ...
                {
                    Login.AddLoginCookie(user.UserId, user.Email, user.Password, null);
                }
