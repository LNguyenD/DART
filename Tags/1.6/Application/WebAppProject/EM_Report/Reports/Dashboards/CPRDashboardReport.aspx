        ...
        function fixPortfolioLayout() {
            ...
            if (document.URL.toLowerCase().indexOf('level2') > 0) {
                ...
                if ($.browser.msie || isIE11()) {
                    ...
                    $("table[alt^='portfolio']").parents('div:eq(1)').css('width', '');
                }
                ...
                portfolioTable.find('tr:gt(1)').find('a').each(function () {
                    ...
                    if (linkContent == "-") {
                        ...
                        if (tableName.toLowerCase().indexOf('week') > -1) {
                            ...
                            startDate.setDate(yesterdayDate.getDate() - 14);
                            endDate = yesterdayDate;
                        }
                        else if (tableName.toLowerCase().indexOf('month') > -1) {
                            var lastMonthDate = new Date();
                            lastMonthDate.setDate(lastMonthDate.getMonth() - 1);
                        ...
                        var startDateParam = '&Start_Date=' + startDate.getFullYear() + '-' + (startDate.getMonth() + 1) + '-' + startDate.getDate();
                        var endDateParam = '&End_Date=' + endDate.getFullYear() + '-' + (endDate.getMonth() + 1) + '-' + endDate.getDate();
                        queryString += startDateParam + endDateParam;
