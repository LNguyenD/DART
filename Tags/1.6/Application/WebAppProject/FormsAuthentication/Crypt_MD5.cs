...
namespace Microsoft.Samples.ReportingServices.CustomSecurity
{
    public class Crypt_MD5
    {
        ...
        public static bool IsMatchingHash(string password, string salt, string hash)
        {
            ...
            return EncryptMD5WithSalts(password, salt) == hash;
        }

        // Create a hash of the given password and salt.
        public static string EncryptMD5WithSalts(string password, string salt)
        {
        ...
        public static Byte[] EncryptMD5s(string inputText)
        {
