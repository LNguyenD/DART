$(document).ready(function () {
    ...
    if ($("table[name=tbGrid]").length > 0) {        
        if ($("table[name=tbGrid] > tbody > tr").length <= 0) {
            ...
            $("table[name=tbGrid]").append("<tbody><tr class='gradeA odd'><td colspan='" + colNo + "' style='text-align:center;color:Red;height:80px;border-right:1px solid #C8C8C8'>No item found!</td></tr></tbody>");
        }
    }
    //
    ...
    $("div.Paging a[href*='page']").each(function () {
        ...
        $(this).bind('click', function () {
            $("div.Paging").parent().children("#hddPaging").val($(this).attr('title'));
