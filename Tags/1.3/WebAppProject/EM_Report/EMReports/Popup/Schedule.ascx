<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Schedule.ascx.cs" Inherits="EM_Report.EMReports.Popup.Schedule1" %>
<%@ Register src="../UserControls/CustomTime.ascx" tagname="CustomTime" tagprefix="uc2" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div>
                    <asp:Button runat="server" ID="btnOK" Text="OK" onclick="btnOK_Click" OnClientClick="CloseDialog();"/>
                    <asp:Button runat="server" ID="btnCancel" Text="Cancel" OnClientClick="CloseDialog();"
