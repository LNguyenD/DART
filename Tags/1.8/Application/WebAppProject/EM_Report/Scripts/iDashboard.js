...
function AdjustMetricLightLevel0() {
    ...
    $("table#tbTrafficLight_TMF").css("width", "100%");
    $("table#tbTrafficLight_EML").css("width", "100%");
    $("table#tbTrafficLight_HEM").css("width", "100%");
    ...
    $("table#tbTrafficLight_TMF td").css('vertical-align', 'middle');
    ...
    $("table#tbTrafficLight_EML td").css('vertical-align', 'middle');
    ...
    $("table#tbTrafficLight_HEM td").css('vertical-align', 'middle');

    $("table#tbTrafficLight_TMF tr[height=0]").next().children("td:not(:first)").css("width", "14.29%");
    $("table#tbTrafficLight_EML tr[height=0]").next().children("td:not(:first)").css("width", "14.29%");
    $("table#tbTrafficLight_HEM tr[height=0]").next().children("td:not(:first)").css("width", "14.29%");

    //fix metriclight position in IE8 compat

    if ($.browser.msie && $.browser.version < 8 && document.documentMode < 8) {
        var marginLeft = screen.width <= 1024 ? -13 : -24;
        $("table#tbTrafficLight_TMF").css({ "width": "auto", "margin-left": marginLeft + "px" });
        $("table#tbTrafficLight_EML").css({ "width": "auto", "margin-left": marginLeft + "px" });
        $("table#tbTrafficLight_HEM").css({ "width": "auto", "margin-left": marginLeft + "px" });
    }
}
...
function AdjustMetricLightLevel1() {
    ...
    //    $("table#tbTrafficLight_Table1").css("width", "99.99%");
    //    $("table#tbTrafficLight_Table2").css("width", "99.99%");
    //    $("table#tbTrafficLight_Table3").css("width", "99.99%");

    //    // align metric light to center

    //    $("table#tbTrafficLight_Table1 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '');
    //    $("table#tbTrafficLight_Table1 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '10mm');

    //    $("table#tbTrafficLight_Table2 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '');
    //    $("table#tbTrafficLight_Table2 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '10mm');

    //    $("table#tbTrafficLight_Table3 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '');
    //    $("table#tbTrafficLight_Table3 tr[valign=top]").next().children("td").find('table').closest('td').css('width', '10mm');
    ...
    //else {
        ...
        $("table#tbTrafficLight_Table1 td").css('vertical-align', 'middle');
        ...
        $("table#tbTrafficLight_Table2 td").css('vertical-align', 'middle');
        ...
        $("table#tbTrafficLight_Table3 td").css('vertical-align', 'middle');
        ...
        if (document.URL.toLowerCase().indexOf('wow') >= 1) {
            $("table#tbTrafficLight_Table1 tr[height=0]").next().children("td:not(:first)").css("width", "50%");
            $("table#tbTrafficLight_Table2 tr[height=0]").next().children("td:not(:first)").css("width", "50%");
            $("table#tbTrafficLight_Table3 tr[height=0]").next().children("td:not(:first)").css("width", "50%");
        }
        else {
    ...
    content.find("input").each(function () {
        ...
        if (flag == true) {
            ...
            if (href == "1-2" || href == "3-5") {
                ...
                //href = href.replace("CPR TMF", "Claims portfolio report last 12 months");
                //href = href.replace("CPR WCNSW", "Claims portfolio report last 12 months");                
                //href = href.replace("CPR Hospitality", "Claims portfolio report last 12 months");
