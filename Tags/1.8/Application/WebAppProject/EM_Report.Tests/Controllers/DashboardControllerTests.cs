...
namespace EM_Report.Tests.Controllers
{
    ...
    public class DashboardControllerTests : BaseControllerTests
    {
        ...
        //    var dashboard_OrganisationRole_LevelsRepoMock = new Mock<IDashboard_OrganisationRole_LevelsRepository>();
        //    dashboard_OrganisationRole_LevelsRepoMock.Setup(r => r.HaveDashboardPermission(It.IsAny<bool>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<short>())).Returns(false);
        ...
        //    var dashboard_OrganisationRole_LevelsRepoMock = new Mock<IDashboard_OrganisationRole_LevelsRepository>();
        //    dashboard_OrganisationRole_LevelsRepoMock.Setup(r => r.HaveDashboardPermission(It.IsAny<bool>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<short>())).Returns(true);
        ...
        //    var dashboard_OrganisationRole_LevelsRepoMock = new Mock<IDashboard_OrganisationRole_LevelsRepository>();
        //    dashboard_OrganisationRole_LevelsRepoMock.Setup(r => r.HaveDashboardPermission(It.IsAny<bool>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<short>())).Throws<Exception>();
