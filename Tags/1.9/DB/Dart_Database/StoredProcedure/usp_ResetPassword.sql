/****** Object:  StoredProcedure [dbo].[usp_ResetPassword]    Script Date: 01/03/2012 13:56:21 ******/
IF  EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[usp_ResetPassword]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_ResetPassword]
GO
...
GO
create PROCEDURE [dbo].[usp_ResetPassword] (@UserNameOrEmail varchar(256),@PassWordReset varchar(256)) 
