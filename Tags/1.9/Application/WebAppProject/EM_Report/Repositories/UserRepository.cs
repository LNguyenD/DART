...
namespace EM_Report.Repositories
{
    ...
    public class UserRepository : RepositoryBase, IUserRepository
    {
        ...
        public User GetUserbyCronJob(bool isinternaluser)
        {
            var request = new UserRequest();
            if (isinternaluser)
            {
                request.LoadOptions = new string[] { Resource.Get_Internal_User_by_CronJob };
            }
            else
            {
                request.LoadOptions = new string[] { Resource.Get_External_User_by_CronJob };
            }
