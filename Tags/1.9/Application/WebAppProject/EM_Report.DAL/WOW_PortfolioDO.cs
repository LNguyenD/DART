...
namespace EM_Report.DAL
{
    ...
    public partial class WOW_PortfolioDO
    {
        ...
        public Nullable<System.DateTime> Date_Status_Changed { get; set; }
        ...
        public string Cost_Code4 { get; set; }
        public string Cost_Code5 { get; set; }
        public Nullable<int> Weeks_Since_DON { get; set; }
        public string Injury_Type { get; set; }
        public string Mechanism_Of_Injury { get; set; }
    }
}
