...
BEGIN
	...
	cross join
	(
		SELECT DISTINCT Value AS division FROM uv_WOW_Type WHERE [Type] = 'division' AND Value <> ''
	) as tmp_value
	...
	cross join 
	(
		SELECT DISTINCT Value AS [State] FROM uv_WOW_Type WHERE [Type] = 'state' AND Value <> ''
	) as tmp_value
	...
	cross join 
	(
		SELECT DISTINCT Value AS [Group] FROM uv_WOW_Type WHERE [Type] = 'group' AND Value <> ''
	) as tmp_value
