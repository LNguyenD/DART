/****** Object:  StoredProcedure [dbo].[usp_SaveSystemRoles]    Script Date: 01/03/2012 13:56:21 ******/
IF  EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[usp_SaveSystemRoles]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_SaveSystemRoles]
GO
...
create PROC [dbo].[usp_SaveSystemRoles](@System_RoleId bigint,@Name varchar(256),@Description nvarchar(500),@SystemRoles varchar(500),@UpdatedBy int)
AS	
