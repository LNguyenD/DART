/****** Object:  StoredProcedure [dbo].[usp_Arrange_Organisation_Levels]    Script Date: 01/03/2012 13:56:21 ******/
IF  EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].[usp_Arrange_Organisation_Levels]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_Arrange_Organisation_Levels]
GO
...
create PROC [dbo].[usp_Arrange_Organisation_Levels](@data varchar(500),@updatedby int)
AS	
