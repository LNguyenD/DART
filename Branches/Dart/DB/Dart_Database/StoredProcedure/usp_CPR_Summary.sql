	...
	BEGIN
		SET @SQL = 'SELECT Value,
					...
					/* BEGIN WOW */
						 ...
						 WHEN Value = ''ALH'' THEN 15
						 WHEN Value = ''Supermarkets'' THEN 16
						 WHEN Value = ''Logistics'' THEN 17
						 WHEN Value = ''BIG W'' THEN 18
						 WHEN Value = ''Dick Smith'' THEN 19
						 WHEN Value = ''Petrol'' THEN 20
						 WHEN Value = ''BWS'' THEN 21
						 WHEN Value = ''Dan M'' THEN 22
						 WHEN Value = ''Corporate'' THEN 23
					/* END WOW */
					/* BEGIN HEM */
