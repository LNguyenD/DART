namespace EM_Report.Service.ServiceContracts
{
    ...
    public interface IActionService
    {
        ...
        [OperationContract]
        DashboardExternal_GroupsResponse GetDashboardExternal_Groups(DashboardExternal_GroupsRequest request);

        [OperationContract]
        DashboardExternal_GroupsResponse SetDashboardExternal_Groups(DashboardExternal_GroupsRequest request);
        ...
        [OperationContract]
        CONTROLResponse GetCONTROL(CONTROLRequest request);
    }
}