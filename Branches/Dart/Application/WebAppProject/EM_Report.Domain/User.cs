namespace EM_Report.Domain
{
    ...
    public class User : I_Status
    {
        ...
        private Dictionary<string, int> _teamIdList;
        [DataMember]
        public Dictionary<string, int> TeamIdList 
        {
            get { return _teamIdList ?? (_teamIdList = new Dictionary<string, int>()); }
            set { _teamIdList = value; }
        }

        private Dictionary<string, int> _organisation_RoleIdList;
        [DataMember]
        public Dictionary<string, int> Organisation_RoleIdList
        {
            get { return _organisation_RoleIdList ?? (_organisation_RoleIdList = new Dictionary<string, int>()); }
            set { _organisation_RoleIdList = value; }
        }

        private Dictionary<string, int> _organisation_LevelIdList;
        [DataMember]
        public Dictionary<string, int> Organisation_LevelIdList
        {
            get { return _organisation_LevelIdList ?? (_organisation_LevelIdList = new Dictionary<string, int>()); }
            set { _organisation_LevelIdList = value; }
        }

        private Dictionary<string, int> _external_GroupIdList;
        [DataMember]
        public Dictionary<string, int> External_GroupIdList
        {
            get { return _external_GroupIdList ?? (_external_GroupIdList = new Dictionary<string, int>()); }
            set { _external_GroupIdList = value; }
        }
