...
namespace EM_Report.BLL.Services
{
    ...
    public interface I_WOWPortfolioService
    {
        ...
        IEnumerable<Dashboard_Claim_Liability_Indicator> GetCliamLiabilityIndicators(string systemName);
    }
    ...
    public class WOWPortfolioService : ServiceBase<string, WOW_PortfolioDO>, I_WOWPortfolioService
    {
        ...
        public IEnumerable<Dashboard_Claim_Liability_Indicator> GetCliamLiabilityIndicators(string systemName)
        {
            var all = ClaimLiabilityIndicator.GetQueryable();
            var result = (from p in all
                          where p.System == systemName
                          select new Dashboard_Claim_Liability_Indicator
                          {
                              Id = p.Id,
                              System = p.System,
                              Liability_Id = p.Liability_Id,
                              Liability_Code = p.Liability_Code,
                              Description = p.Description
                          }).ToList();
