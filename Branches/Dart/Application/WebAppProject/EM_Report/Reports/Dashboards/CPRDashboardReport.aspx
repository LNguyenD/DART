...
<body style="margin: 0;">
    ...
    <script type="text/javascript" language="javascript">
        ...
        Sys.Application.add_load(function () {
            ...
            $('iframe#ifReport_Agency', window.parent.document).contents().find('img').closest('a').each(function () {                
                if ($(this).attr('href') != "javascript:void(0)")
                    $(this).attr('href', $(this).attr('href').replace('javascript:void(', ''));
            });
            
            $('iframe#ifReport_week', window.parent.document).contents().find('img').closest('a').each(function () {
                if ($(this).attr('href') != "javascript:void(0)")                    
                    $(this).attr('href', $(this).attr('href').replace('javascript:void(', ''));
            });
            $('iframe#ifReport_month', window.parent.document).contents().find('img').closest('a').each(function () {
                if ($(this).attr('href') != "javascript:void(0)")
                    $(this).attr('href', $(this).attr('href').replace('javascript:void(', ''));
            });           
        ...
        function PreventLoadingTabs(status) {
            ...
            if (document.URL.toLowerCase().indexOf('tmf') >= 1) {
                ...
                else if (document.URL.toLowerCase().indexOf('type=portfolio') >= 1) {
                    $("#tab_group", window.parent.document).css('pointer-events', status);
                    $("#tab_broker", window.parent.document).css('pointer-events', status);
                }
                else {
                ...
                else if (document.URL.toLowerCase().indexOf('type=account_manager') >= 1) {
                    $("#tab_group", window.parent.document).css('pointer-events', status);
                    $("#tab_employer_size", window.parent.document).css('pointer-events', status);
                    $("#tab_broker", window.parent.document).css('pointer-events', status);
                }
        ...
        function hideShowCPRTablesAndMetricLight(portfolioTableName, metricTableName) {
            ...
            var uSess = '<%=EM_Report.Helpers.Base.LoginSession.External_GroupName %>';
            if (uSess != '') {
                $("table[alt*='portfolio_week_group']").closest('div').remove();
                $("table[alt*='portfolio_month_group']").closest('div').remove();
            }
        }
