...
<body style="margin: 0;">
    ...
    <script type="text/javascript" language="javascript">        
        ...
        Sys.Application.add_load(function () {
            ...
            var viewType = capitalize(getCurrentType());
            if (viewType == 'Accountmanager')
                viewType = "AccountManager";
            
            // rtw level2
            $("iframe#ifReport_" + viewType, window.parent.document).contents().find('a').each(function () {
                var frame = $(this);                
                frame.attr('href', $(this).attr('href').replace('javascript:void(', ''));
            });
            // rtw level 3
            $("iframe#ifReport", window.parent.document).contents().find('a').each(function () {
                var frame = $(this);                
                frame.attr('href', $(this).attr('href').replace('javascript:void(', ''));
            });
