...
*******************/
	...
	imageRadioChecked = window.g_baseUrl + "/images/form_element/radiobuttonChecked.png";
	imageRadioUnchecked = window.g_baseUrl + "/images/form_element/radiobuttonUnchecked.png";
	imageSelectDropDownArrow = window.g_baseUrl + "/images/form_element/selectDrop.gif";
	imageCheckboxDisabled = window.g_baseUrl + "/images/form_element/disabled.gif";
