...
function AdjustMetricLightLevel0() {
    ...
    $("table[alt='level0_wow']").attr("title", '');
...
function AdjustMetricLightLevel1() {
    ...
    $("table[alt='level1_table4']").attr("id", "tbTrafficLight_Table4");
    ...
    // fix issue when change size of browser
    if (document.URL.toLowerCase().indexOf("hem_level1") >= 0){
        $("table[alt='level1_table3']").closest('td').attr('colspan', '2');
        $("table[alt='level1_table3']").closest('tr').find('td:eq(1)').css('display', 'none');
    }
    else if (document.URL.toLowerCase().indexOf("eml_level1") >= 0){
        $("table[alt='level1_table4']").closest('td').attr('colspan', '2');
        $("table[alt='level1_table4']").closest('tr').find('td:eq(1)').css('display', 'none');
    }
...
function AdjustTitlteHeight() {
    ...
    $("td[alt^='title_graph_']").each(function () {
        if ($(this).attr("alt").indexOf("view_") < 0) {
            $(this).children("div").css({ "width": "", "margin-right": "10px" });
